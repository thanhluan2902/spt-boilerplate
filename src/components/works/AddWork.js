    ...
    return (
        <div className="noPadding right_wrap">
            ...
            <div className="main_navbar headding">
                <h1>
                    <i className="fa fa-bars" aria-hidden="true" id="toggle_nav" /> Thêm mới việc nhà
                </h1>
            </div>
            {/* ------------------------------------------------------------ */}
                    ...
                    <div className="col-12">
                        <form className="mr_bot50">
                            <div className="mb-4">
                                ...
                                <input type="text" className="form-control" name="email" id="exampleEmail" placeholder="Nhập tiêu đề" />
                            </div>
                            <div className="mb-4">
                            ...
                            <div className="mb-4 form3 uploadButton">
                                ...
                                <input className="form-control" type="text" placeholder="Nhập số lượng" name="password" id="examplePassword" />
                            </div>
                            <br />
                            <div className="mb-4">
                            ...
                            <button type="button" className="btn btn-primary btn-block">Tạo mới</button>
